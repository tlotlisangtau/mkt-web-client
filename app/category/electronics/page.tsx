...
const types = ["Type", "Cell Phones", "Computers", "TV and Audio", "Camera", "Other Equipment"];
const locations = [
  "Location",
  "Maseru",
  "Leribe",
...
const ProductList: React.FC = () => {
  ...
  const filteredProducts = products.filter((product) => {
    return (
      (selectedType === "Type" || product.electronic_types === selectedType) &&
      ...
      <section className="w3l-products-page w3l-blog-single w3l-products-4">
        <div className="single blog">
          <div className="wrapper">
            <h3 className="title-main" ref={tabContentRef}>Electronics</h3>
