...
>
  <ul>
    <li className={`p-2 mb-5 ${activeSection === 'dashboard' ? 'active' : ''}`}>
    ...
    <li className={`p-2 mb-5 ${activeSection === 'profile-settings'? 'active' : ''}`}>
    ...
    <li className={`p-2 mb-5 ${activeSection === 'myAds'? 'active' : ''}`}>
      ...
      <li className={`p-2 mb-5 ${activeSection === 'messages'? 'active' : ''}`}>
            <a href="javascript:void(0);" onClick={() => handleNavClick('messages')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
          ...
          <li className={`p-2 hover:bg-gray-700 mb-5 ${activeSection === 'logout' ? 'tg-active' : ''}`}>
            <a href="javascript:void(0);"  onClick={() => handleNavClick('logout')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
