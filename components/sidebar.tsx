      ...
      <div className="right-side-bar">
        <aside>
          ...
          <form className="form-inline search-form" action="#" method="post">
            <input className="form-control" type="search" placeholder="Search here..." aria-label="search" required />
        ...
        <aside className="posts p-4 border single-left-inner">
          ...
          <div className="brand-equal">
            <input type="radio" name="radio" className="radio-input" id="all" defaultChecked />
            <label htmlFor="all" className="brand-name">All</label>
          </div>
          <div className="brand-equal">
            <input type="radio" name="radio" className="radio-input" id="sell" />
            <label htmlFor="sell" className="brand-name">Sell</label>
          </div>
          <div className="brand-equal">
            <input type="radio" name="radio" className="radio-input" id="auction" />
            <label htmlFor="auction" className="brand-name">Auction</label>
          </div>
          <div className="brand-equal">
            <input type="radio" name="radio" className="radio-input" id="buy" />
            <label htmlFor="buy" className="brand-name">Buy</label>
          </div>
          <div className="brand-equal">
            <input type="radio" name="radio" className="radio-input" id="exchange" />
            <label htmlFor="exchange" className="brand-name">Exchange</label>
          </div>
          <div className="brand-equal">
            <input type="radio" name="radio" className="radio-input" id="gift" />
            <label htmlFor="gift" className="brand-name">Gift</label>
          </div>
          <div className="brand-equal">
            <input type="radio" name="radio" className="radio-input" id="rent" />
            <label htmlFor="rent" className="brand-name">Rent</label>
          </div>
          <div className="brand-equal">
            <input type="radio" name="radio" className="radio-input" id="job-offer" />
            <label htmlFor="job-offer" className="brand-name">Job - Offer</label>
          </div>
          <div className="brand-equal">
            <input type="radio" name="radio" className="radio-input" id="job-wanted" />
            <label htmlFor="job-wanted" className="brand-name">Job - Wanted</label>
          </div>
        </aside>
        <aside>
          <h3 className="aside-title mb-3">Advertisement</h3>
          <img src="assets/images/screen.jpg" alt="Advertisement" className="img-fluid img-responsive" />
        </aside>
      </div>
      {/* //right side bar */}
      ...
      <div className="tab-content text-left">
        <aside className="top-border d-flex">
          ...
          <div className="input-group-btn">
            <select className="btn btn-default" name="sort" defaultValue="Sort By Date">
        ...
        <div className="d-grid grid-col-2">
          <div className="product">
            <a href="product-single.html"><img src="assets/images/ps1.jpg" className="img-responsive" alt="Product 1" /></a>
          ...
          <div className="product">
            <a href="product-single.html"><img src="assets/images/ps2.jpg" className="img-responsive" alt="Product 2" /></a>
            <div className="info-bg">
              <h5><a href="product-single.html">Eaque ipsa quae ab illo inventore veritatis</a></h5>
              <p>Nulla ex nunc</p>
              <ul className="d-flex">
                <li><span className="fa fa-usd"></span> 299</li>
                <li className="margin-effe"><a href="#fav" title="Add this to Favorite"><span className="fa fa-heart-o"></span></a></li>
                <li><a href="#share" title="Share"><span className="fa fa-share"></span></a></li>
              </ul>
            </div>
          ...
          <div className="product">
            <a href="product-single.html"><img src="assets/images/ps3.jpg" className="img-responsive" alt="Product 3" /></a>
            <div className="info-bg">
              <h5><a href="product-single.html">Quasi architecto beatae vitae dicta sunt</a></h5>
              <p>Nulla ex nunc</p>
              <ul className="d-flex">
                <li><span className="fa fa-usd"></span> 900</li>
                <li className="margin-effe"><a href="#fav" title="Add this to Favorite"><span className="fa fa-heart-o"></span></a></li>
                <li><a href="#share" title="Share"><span className="fa fa-share"></span></a></li>
              </ul>
            </div>
